<title>CMS | Update Contactus</title>
...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Update Contactus</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="page-body">
    <div class="row">
	    ...
	    <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="contact_name" id="contact_name" placeholder="Contact Name" value="<?php echo $contact_name; ?>" />
                            </div>
	    <div class="form-group">
                                <label for="varchar">Contact Email <?php echo form_error('contact_email') ?></label>
                                <input type="text" class="form-control" name="contact_email" id="contact_email" placeholder="Contact Email" value="<?php echo $contact_email; ?>" />
                            </div>
	    <div class="form-group">
                                <label for="contact_comment">Contact Comment <?php echo form_error('contact_comment') ?></label>
                                <textarea class="form-control" rows="3" name="contact_comment" id="contact_comment" placeholder="Contact Comment"><?php echo $contact_comment; ?></textarea>
                            </div>
	    <div class="form-group">
                                <label for="date">Contact Date Issue <?php echo form_error('contact_date_issue') ?></label>
                                <input type="date" class="form-control" name="contact_date_issue" id="contact_date_issue" placeholder="Contact Date Issue" value="<?php echo $contact_date_issue; ?>" />
                                </div>
