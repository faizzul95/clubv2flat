...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">List Of Contactus</a>
            </li>
        </ul>
    </div>
</div>
...
<!-- Basic Button table start -->
            <div class="card">
                <div class="card-header">
                        <?php echo anchor(site_url('contactus/create'), '<i class="fa fa-wpforms"></i> Add Data', 'class="btn btn-info"'); ?>
		<?php echo anchor(site_url('contactus/excel'), '<i class="fa fa-file-excel-o"></i> Export as Excel', 'class="btn btn-success btn-square"'); ?>
		<?php echo anchor(site_url('contactus/word'), '<i class="fa fa-file-word-o"></i> Export as Word', 'class="btn btn-inverse btn-square"'); ?>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "contactus/json", "type": "POST"},
                    columns: [
                        {
                            "data": "contact_id",
                            "orderable": false
                        },{"data": "contact_name"},{"data": "contact_email"},{"data": "contact_comment"},{"data": "contact_date_issue"},
                        {
                            "data" : "action",
                            "orderable": false,
