<title>CMS | List Of Menu_access</title>
    
<!-- Page-header start -->
<div class="page-header">
    <div class="page-header-title">
        <h4> List Of Menu_access</h4>
    </div>
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">List Of Menu_access</a>
            </li>
        </ul>
    </div>
</div>
...
<!-- Basic Button table start -->
            <div class="card">
                <div class="card-header">
                        <?php echo anchor(site_url('menu_access/create'), '<i class="fa fa-wpforms"></i> Add Data', 'class="btn btn-info"'); ?>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "menu_access/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id",
                            "orderable": false
                        },{"data": "id_user_level"},{"data": "menu_id"},
                        {
                            "data" : "action",
                            "orderable": false,
