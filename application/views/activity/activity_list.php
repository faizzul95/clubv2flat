...
<head>
  ...
  <body class="fix-menu">
    ...
    <div class="main-body">
		...
		<?php echo anchor(site_url('activity/excel'), '<i class="icofont icofont-download-alt"></i> Export as Excel', 'class="btn btn-success btn-square"'); ?>
		<?php echo anchor(site_url('activity/word'), '<i class="icofont icofont-download-alt"></i> Export as Word', 'class="btn btn-inverse btn-square"'); ?>
                            </div>
