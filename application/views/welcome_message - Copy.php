        ...
        <div class="container">
          ...
          <div class="services">
            <div class="col-sm-3 wow fadeInUp" data-wow-delay="0.2s">
              <div>
                <img src="<?= base_url(); ?>/assets/image/group_member/MOHD FAHMY IZWAN BIN ZULKHAFRI.png" style="border-radius: 50%;" height="120" width="120" alt="Team Leader" />
              </div>
            ...
            <div class="col-sm-3 wow fadeInUp" data-wow-delay="0.3s">
              <div>
                <img class="icon-2" src="<?= base_url(); ?>/assets/image/group_member/MUHAMMAD SYAMIM BIN SAMSUDIN.png" style="border-radius: 50%;" height="120" width="120"/>
              </div>
              <div class="services-description">
            ...
            <div class="col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
              <div>
                <img class="icon-3" src="<?= base_url(); ?>/assets/image/group_member/AMRULLAH BIN ABDUL RAHMAN.png" style="border-radius: 50%;" height="120" width="120" />
              </div>
              <div class="services-description">
            ...
            <div class="col-sm-3 wow fadeInUp" data-wow-delay="0.4s">
              <div>
                <img class="icon-3" src="<?= base_url(); ?>/assets/image/group_member/NOR FAEZAH BINTI ABDUL RAZAK.png" style="border-radius: 50%;" height="120" width="120" />
              </div>
              <div class="services-description">
