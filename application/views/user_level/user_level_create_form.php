...
<div class="page-header-breadcrumb">
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="#!">User level</a>
        </li>
        <li class="breadcrumb-item"><a href="#!">Add New User level</a>
        </li>
    </ul>
</div>
</div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <form action="<?php echo $action; ?>" method="post">
                            ...
                            <label for="varchar">Level Name <?php echo form_error('nama_level') ?></label>
                            <input type="text" <?php if (form_error('nama_level')) { echo 'class="form-control form-control-danger"'; } else { echo 'class="form-control"'; }  ?> name="nama_level" id="nama_level" autocomplete="off" placeholder="Level Name" value="<?php echo $nama_level; ?>" />
                        </div>
