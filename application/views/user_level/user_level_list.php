<title>CMS | List Of User Access</title>
    
<!-- Page-header start -->
<div class="page-header">
    <div class="page-header-title">
        <h4> List Of User Access</h4>
    </div>
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">List Of User Access</a>
            </li>
        </ul>
    </div>
</div>
...
<!-- Basic Button table start -->
            <div class="card">
                <div class="card-header">
                        <?php echo anchor(site_url('user_level/create'), '<i class="fa fa-wpforms"></i> Add New User Level', 'class="btn btn-info"'); ?>
                </div>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "user_level/json", "type": "POST"},
                    columns: [
                        {
                            "data": "id_user_level",
                            "orderable": true
