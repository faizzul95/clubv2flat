...
<div class="page-header-breadcrumb">
    <ul class="breadcrumb-title">
        ...
        <li class="breadcrumb-item"><a href="#!">Add NewMenu</a>
        </li>
    </ul>
</div>
</div>
    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            ...
            <form action="<?php echo $action; ?>" method="post">
                            ...
                            <input type="text" <?php if (form_error('menu_title')) { echo 'class="form-control form-control-danger"'; } else { echo 'class="form-control"'; }  ?> name="menu_title" id="menu_title" autocomplete="off" placeholder="Menu Title" value="<?php echo $menu_title; ?>" />
                        </div>
											      <div class="form-group">
                            <label for="varchar">Menu Url <?php echo form_error('menu_url') ?></label>
                            <input type="text" <?php if (form_error('menu_url')) { echo 'class="form-control form-control-danger"'; } else { echo 'class="form-control"'; }  ?> name="menu_url" id="menu_url" autocomplete="off" placeholder="Menu Url" value="<?php echo $menu_url; ?>" />
                        </div>
											      <div class="form-group">
                            <label for="varchar">Menu Icon <?php echo form_error('menu_icon') ?></label>
                            <input type="text" <?php if (form_error('menu_icon')) { echo 'class="form-control form-control-danger"'; } else { echo 'class="form-control"'; }  ?> name="menu_icon" id="menu_icon" autocomplete="off" placeholder="Menu Icon" value="<?php echo $menu_icon; ?>" />
                        </div>
											      <div class="form-group">
                            <label for="int">Is Main Menu <?php echo form_error('is_main_menu') ?></label>
                            <input type="number"  <?php if (form_error('is_main_menu')) { echo 'class="form-control form-control-danger"'; } else { echo 'class="form-control"'; }  ?> name="is_main_menu" id="is_main_menu" min="0" placeholder="Is Main Menu" value="<?php echo $is_main_menu; ?>" />
                            </div>
											    <div class="form-group">
