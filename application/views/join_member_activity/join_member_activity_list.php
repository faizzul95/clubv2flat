<title>CMS | List Of Activity Request</title>
    
<!-- Page-header start -->
<div class="page-header">
    <div class="page-header-title">
        <h4> List Of Activity Request</h4>
    </div>
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">List Of Activity Request</a>
            </li>
        </ul>
    </div>
</div>
...
<!-- Basic Button table start -->
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                var t = $("#mytable").dataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: {"url": "join_member_activity/json", "type": "POST"},
                    columns: [
                        {
                            "data": "member_activity_id",
                            "orderable": false
                        },{"data": "detail_fullname"},{"data": "act_name"},{"data": "join_date"},{"data": "join_status"},
                        {
                            "data" : "action",
                            "orderable": false,
        ...
        <script type="text/javascript">
            ...
            swal({
                ...
                confirmButtonText: "Yes, i want to approve.",
              ...
              if (isConfirm) {
                 $.ajax({
                     ...
                     success: function(data) {
                          swal("Success!", "Account has been approval.", "success");
            ...
            swal({
              ...
              if (isConfirm) {
                 $.ajax({
                     ...
                     success: function(data) {
                          swal("Rejected!", "The request has been reject.", "success");
