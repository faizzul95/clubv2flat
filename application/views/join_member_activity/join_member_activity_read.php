<title>CMS | Join_member_activity View</title>
   
                    <!-- Page header start -->
                    <div class="page-header">
                        <div class="page-header-title">
                            <h4>View Join_member_activity</h4>
                        </div>
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="#!">View Join_member_activity</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="card">
                                    <div class="card-block">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Act Id</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="Disabled text" value="<?php echo $act_id; ?>" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="Disabled text" value="<?php echo $join_date; ?>" disabled>
                                                </div>
                                            </div>
    
                                            <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Join Status</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" placeholder="Disabled text" value="<?php echo $join_status; ?>" disabled>
                                                </div>
                                            </div>
	  <a href="<?php echo site_url('join_member_activity') ?>" class="btn btn-info btn-square pull-left"><i class="icofont icofont-arrow-left"></i> Back</a>
