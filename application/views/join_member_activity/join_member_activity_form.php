<title>CMS | Update Join_member_activity</title>

<!-- Page header start -->
<div class="page-header">
    <div class="page-header-title">
        <h4>Update Join_member_activity</h4>
    </div>
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="#!">Update Join_member_activity</a>
            </li>
        </ul>
    </div>
</div>
...
<div class="page-body">
    <div class="row">
	    ...
	    <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="act_id" id="act_id" placeholder="Act Id" value="<?php echo $act_id; ?>" />
                            </div>
	    <div class="form-group">
	    ...
	    <div class="form-group">
                                ...
                                <input type="date" class="form-control" name="join_date" id="join_date" placeholder="Join Date" value="<?php echo $join_date; ?>" />
                                </div>
	    <div class="form-group">
                                <label for="enum">Join Status <?php echo form_error('join_status') ?></label>
                                <input type="text" class="form-control" name="join_status" id="join_status" placeholder="Join Status" value="<?php echo $join_status; ?>" />
                            </div>
