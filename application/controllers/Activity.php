...
class Activity extends CI_Controller
{
    ...
    {
        check_login();
        $this->template->load('template','activity/activity_list');
    } 
    ...
    public function read($id) 
    {
        ...
        $this->template->load('template','activity/activity_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->load('template','activity/activity_create_form', $data);
    }
    ...
    public function update($id) 
    {
		...
		'act_fee' => set_value('act_fee', $row->act_fee),
             ...
             $this->template->load('template','activity/activity_form', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('activity'));
        }
