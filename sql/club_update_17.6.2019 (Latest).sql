...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jun 17, 2019 at 03:19 AM
...
(1, 'asd', 'asd', 'asd', '2019-06-14', '13:00:00', 'asd', 'member', 'asd', 20),
(2, 'Berkayak', 'Berkayak', 'q', '2019-07-05', '12:31:00', 'a', 'member', 'a', 21),
(3, 'Snorkling', 'Snorkling', 'a', '2019-06-13', '12:12:00', 'a', 'member', 'a', 0);
...
CREATE TABLE IF NOT EXISTS `join_member_activity` (
  ...
  `join_status` enum('pending','approve','reject') DEFAULT NULL,
  PRIMARY KEY (`member_activity_id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `join_member_activity`
--

INSERT INTO `join_member_activity` (`member_activity_id`, `act_id`, `user_id`, `join_date`, `join_status`) VALUES
(6, 3, 2, '2019-06-17', 'pending');
...
(7, 'Activity', 'a', 'icofont icofont-law-document', 0, 'y'),
...
(11, 'List of Activity', 'activity_member', 'icofont icofont-space-shuttle', 0, 'y'),
(12, 'List of Activity Request', 'join_member_activity', 'a', 7, 'y');
...
(3, 'test', '$2y$10$az4hDKDmEU3UkA3Ko8R0d.dTOyjY9Pr5eFzX2H2b4daBsjQM/0I.C', 'member', 'test2.png', 'inactive');
