...
if (isset($_POST['generate']))
{
    ...
    if ($table_name <> '')
    {
        ...
        $v_create_form = $table_name . "_create_form";
        ...
        $v_create_form_file = $v_create_form . '.php';
        ...
        include 'core/create_create_form.php';
...
if (isset($_POST['generateall']))
{
    ...
    foreach ($table_list as $row) {
        ...
        $v_read_file = $v_read . '.php';
        $v_form_file = $v_form . '.php';
        $v_create_form = $v_create_form . '.php';
        $v_doc_file = $v_doc . '.php';
        $v_pdf_file = $v_pdf . '.php';
