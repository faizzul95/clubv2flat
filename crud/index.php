            ...
            <ul class="main-navigation">
                ...
                <li class="nav-title" data-i18n="nav.category.navigation">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="tree-1">
                            <li><a href="../index.php/application/create" data-i18n="nav.navigate.navbar">Add New Application</a>
                            </li>
                            <li><a href="../index.php/application" data-i18n="nav.navigate.navbar-inverse">Application List</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a href="#!">
                        ...
                        <ul class="tree-1">
                            ...
                            <li><a href="../index.php/activity" data-i18n="nav.navigate.navbar-inverse">Activity List</a></li>
                        </ul>
                    </li>
                    <li class="nav-item single-item">
                        <a href="widget.html">
